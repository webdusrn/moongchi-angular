...
gets.validate = function(){
    return function(req, res, next){
        ...
        if (req.query.orderBy === undefined) req.query.orderBy = TREATMENT.defaultOrderBy;
        ...
        if (req.query.orderBy !== undefined) req.check("orderBy", "400_3").isEnum(TREATMENT.enumOrderBys);
...
gets.setParam = function() {
    return function(req, res, next) {
        ...
        req.models.AppTreatment.findTreatmentsByOptions(req.query, function (status, data) {
            if (status == 200) {
                req.data = data;
                next();
            } else {
