...
gets.validate = function(){
    return function(req, res, next){
        ...
        var CHARGE = req.meta.std.charge;

        if (req.query.orderBy === undefined) req.query.orderBy = CHARGE.defaultOrderBy;
        ...
        if (req.query.orderBy !== undefined) req.check("orderBy", "400_3").isEnum(CHARGE.enumOrderBys);
        ...
        if (req.query.searchField !== undefined) req.check("searchField", "400_3").isEnum(CHARGE.enumSearchFields);
...
gets.setParam = function() {
    return function(req, res, next) {
        ...
        req.models.AppCharge.findChargesByOptions(req.query, function (status, data) {
            if (status == 200) {
                req.data = data;
                next();
            } else {
